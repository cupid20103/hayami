export const roadmaps = [
  ...
  },
  {
    ...
    content1:
      "In the second phase, we will be launching our 9,999 carefully crafted NFTs onto the ethereum blockchain. With an eye for detail and high standards of quality, we strive to ensure that every NFT we release is perfect.",
    content2:
      "Keep your eyes peeled for secret sneak peeks on our social media platforms and join our discord server to stay up to date with our most recent events.",
  },
  {
  ...
  },
  {
    title: "Phase 6 | Merch",
    content1:
      "Taking Hayami off-chain and into the real world, it's time to release our own exclusive merchandise. We aim to create a wide range of products which encompasses our community as a whole.",
    content2:
      "These designs will be made by both the team and community, and will be another great way for our community members to engage with the project directly. Furthermore, the team will be rewarding artists whose designs make the cut!",
  },
  {
    title: "Phase 7 | Metaverse",
    content1:
      "In the seventh phase, Hayami will be purchasing metaverse land on leading platforms and providers such as The Sandbox. Taking our community to the next level, this will allow us to engage together on unprecedented levels, in a virtual world.",
    content2:
      "What’s more, the team will release playable avatars that will be compatible with the metaverse in question. Hayami is more than just a project: it’s a whole new world.",
  },
];
